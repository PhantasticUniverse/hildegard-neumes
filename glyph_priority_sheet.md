...
| 3 | `rh_c_clef` | 150 | Width 150 (body 122×158) set 2026-04-19 via trace-at-scale from `c_clef.png` — **replaces** the earlier Bravura placeholder. Compact Rhineland calligraphic clef (dash above a thick-thin C). Tier 1 now 6/6 drawn authentically from Rhineland manuscript sources. |
